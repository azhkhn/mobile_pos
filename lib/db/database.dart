...
class EzDatabase {
  ...
  Future<Database> initDB() async {
    ...
    return await openDatabase(dbFile, version: 1, onCreate: _createDB, onUpgrade: _upgradeDB);
  }
  ...
  Future _upgradeDB(Database db, int oldVersion, int newVersion) async {
    ...
    // const blobNotNull = 'BLOB NOT NULL';
...
//========== Table Business Profile ==========
    await db.execute('''CREATE TABLE $tableBusinessProfile (
      ...
      ${BusinessProfileFields.logo} $blobNotNull)''');
