...
abstract class $SubCategoryModelCopyWith<$Res> {
  ...
  $Res call(
      {@JsonKey(name: '_id') int? id, String category, String subCategory});
}
...
class _$_CategoryModel extends _CategoryModel {
  ...
  @override
  String toString() {
    return 'SubCategoryModel(id: $id, category: $category, subCategory: $subCategory)';
  }
...
abstract class _CategoryModel extends SubCategoryModel {
  const factory _CategoryModel(
      {@JsonKey(name: '_id') final int? id,
      required final String category,
      required final String subCategory}) = _$_CategoryModel;
