...
abstract class $ItemMasterModelCopyWith<$Res> {
  factory $ItemMasterModelCopyWith(
          ItemMasterModel value, $Res Function(ItemMasterModel) then) =
      _$ItemMasterModelCopyWithImpl<$Res>;
  $Res call(
...
/// @nodoc
class _$ItemMasterModelCopyWithImpl<$Res>
    implements $ItemMasterModelCopyWith<$Res> {
  _$ItemMasterModelCopyWithImpl(this._value, this._then);

  final ItemMasterModel _value;
  // ignore: unused_field
  final $Res Function(ItemMasterModel) _then;
    ...
    return _then(_value.copyWith(
      ...
      itemName: itemName == freezed
          ...
          : itemName // ignore: cast_nullable_to_non_nullable
              as String,
      itemNameArabic: itemNameArabic == freezed
          ? _value.itemNameArabic
          : itemNameArabic // ignore: cast_nullable_to_non_nullable
              as String,
      ...
      openingStock: openingStock == freezed
          ...
          : openingStock // ignore: cast_nullable_to_non_nullable
              as String,
      alertQuantity: alertQuantity == freezed
...
/// @nodoc
@JsonSerializable()
class _$_ItemMasterModel implements _ItemMasterModel {
  const _$_ItemMasterModel(
  ...
  factory _$_ItemMasterModel.fromJson(Map<String, dynamic> json) =>
      _$$_ItemMasterModelFromJson(json);
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.itemNameArabic, itemNameArabic) &&
            ...
            const DeepCollectionEquality()
                .equals(other.alertQuantity, alertQuantity) &&
  ...
  Map<String, dynamic> toJson() {
    return _$$_ItemMasterModelToJson(this);
  }
}
