...
SalesItemsModel _$SalesItemsModelFromJson(Map<String, dynamic> json) {
  return _SalesItemsModel.fromJson(json);
}
...
mixin _$SalesItemsModel {
  ...
  @JsonKey(ignore: true)
  $SalesItemsModelCopyWith<SalesItemsModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $SalesItemsModelCopyWith<$Res> {
  factory $SalesItemsModelCopyWith(
          SalesItemsModel value, $Res Function(SalesItemsModel) then) =
...
/// @nodoc
class _$SalesItemsModelCopyWithImpl<$Res>
    implements $SalesItemsModelCopyWith<$Res> {
  _$SalesItemsModelCopyWithImpl(this._value, this._then);

  final SalesItemsModel _value;
  // ignore: unused_field
  final $Res Function(SalesItemsModel) _then;
...
class _$_SalesItemsModel implements _SalesItemsModel {
  ...
  factory _$_SalesItemsModel.fromJson(Map<String, dynamic> json) =>
      _$$_SalesItemsModelFromJson(json);
  ...
  Map<String, dynamic> toJson() {
    return _$$_SalesItemsModelToJson(this);
  }
}
...
abstract class _SalesItemsModel implements SalesItemsModel {
  const factory _SalesItemsModel(
      ...
      required final String vatTotal}) = _$_SalesItemsModel;

  factory _SalesItemsModel.fromJson(Map<String, dynamic> json) =
      _$_SalesItemsModel.fromJson;
